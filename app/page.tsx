...
// Add proper typing for the form data
interface FormData {
  name: string;
  email: string;
  company: string;
...
// Add proper typing for the RequestForm props
...
const RequestForm = ({ 
  ...
  <form onSubmit={handleSubmit} className="space-y-4">
    ...
    <div className="mt-4 text-sm text-gray-600">
      ...
      {' '}and we'll do our best to get back to you at the earliest.
    </div>
    <Button
      type="submit"
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 text-center">
            <div className="flex-1 max-w-xl">
              <h2 className="text-3xl font-bold mb-6" style={{ color: brandColors.primary }}>
